...
export function CompetencesTable () {
  ...
  <div class="title">
    ...
    <strong className="">Maquetar una aplicación</strong>
    </div>
...
<label class="accordion-wrapper">
  ...
  <div class="title">
    ...
    <div className="descripcion">
    <strong>Crear una interfaz de usuario web estática y adaptable</strong>
    </div>
    <svg viewBox="0 0 256 512" width="12" title="angle-right" class="side-icon" fill="white">
      <path d="M224.3 273l-136 136c-9.4 9.4-24.6 9.4-33.9 0l-22.6-22.6c-9.4-9.4-9.4-24.6 0-33.9l96.4-96.4-96.4-96.4c-9.4-9.4-9.4-24.6 0-33.9L54.3 103c9.4-9.4 24.6-9.4 33.9 0l136 136c9.5 9.4 9.5 24.6.1 34z" />
    </svg>
  ...
  <div class="content">
	...
	<section id="main">
		<div id="tabs">
			<span class="diana" id="uno1"></span>
			<a href="#uno1" class="tab-e">Nivel 1</a>
			<span class="diana" id="dos1"></span>
			<a href="#dos1" class="tab-e">Nivel 2</a>
			<span class="diana" id="tres1"></span>
			<a href="#tres1" class="tab-e">Nivel 3</a>
